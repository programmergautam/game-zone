  ...
  return (
    ...
    >
      <div className="container mx-auto p-10 mt-32 text-center rounded-lg shadow-lg">
        <h1 className="text-2xl font-extrabold mb-4 neon-text">Welcome to GameZone</h1>
        <p className="text-sm font-bold mb-8 neon-text">Your Ultimate Gaming Experience Awaits!</p>
